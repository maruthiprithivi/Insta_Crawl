...
def instaPost(tag, total=5):
    ...
    counter = total
    done1 = False
    workbook = xlS.Workbook("output/crawl02.xlsx")
...
def instaFollowers(user_id):
        # row3 = 0
        # col3 = 0
        # workbook = xlS.Workbook("output/crawl01.xlsx")
        # worksheet3 = workbook.add_worksheet('Followers')
        # worksheet3.write(row3, col3, "owner_name")
        # worksheet3.write(row3, col3 + 1, "owner_id")
        # worksheet3.write(row3, col3 + 2, "follower_name")
        ...
        while (done2 == False):
            ...
            # To parse the data set into separate segments
                print (str(item['username']))
                print (str(item['id']))
                follower_name.append(str(item['username']))
                follower_id.append(str(item['id']))
                # print follower_name, follower_id
            ...
            try:
                ...
                done2 = True
        return follower_name, follower_id
        """
